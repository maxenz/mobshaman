...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "Estado de sesión de usuario: " + session.isLoggedIn(), Toast.LENGTH_LONG).show();
			...
			public void onClick(View arg0) {
				...
				if(username.trim().length() > 0 && password.trim().length() > 0){
					...
					if(username.equals("test") && password.equals("test")){
						...
						alert.showAlertDialog(LoginActivity.this, "Error de inicio de sesión...", "Usuario/Password incorrecto/s.", false);
					}				
				}else{
